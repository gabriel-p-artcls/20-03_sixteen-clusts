...
% 
   ...
   \title{Sixteen overlooked open clusters}
...
\begin{figure*}[ht]
    \centering
    \includegraphics[width=\hsize]{figs/low_res/DSS2color.png}
...
\begin{figure*}[ht]
    \centering
     \includegraphics[width=.85\hsize]{figs/low_res/V_images.png}   
...
\begin{figure*}[ht]
    ...
    \centering
    \includegraphics[width=.85\hsize]{figs/low_res/V_images2.png}
    \caption{Continued}
    \label{fig2a}
\end{figure*}
...
\begin{figure*}[ht]
    \addtocounter{figure}{-1}
    \centering
    \includegraphics[width=.85\hsize]{figs/low_res/V_images3.png}
    \caption{Continued}
    \label{fig2b}
\end{figure*}
...
\begin{figure*}[ht]
    \centering
    \includegraphics[width=\hsize]{figs/low_res/obs_vdBH73.png}
...
\begin{figure*}[ht]
    \centering
    \includegraphics[width=\hsize]{figs/low_res/dmap_vdbh73.png}
...
\begin{figure*}[ht]
    \centering
    \includegraphics[width=\hsize]{figs/low_res/cmds_vdbh73.png}
    \caption{From left to right: The $V$ vs $(B-V)$ , $V$ vs $(V-I)$ and
    $(B-V)$ vs $(U-B)$ clean diagrams after the removal by field interlopers
    made by \texttt{ASteCA} over van den Bergh-Hagen 73.
...
\begin{figure*}[ht]
    \centering
    \includegraphics[width=\hsize]{figs/low_res/plx_vdBH73.png}
    ...
    probability) in van den Bergh-Hagen 73.
...
\begin{figure*}[ht]
    \centering
    \includegraphics[width=\hsize]{figs/low_res/obs_NGC4349.png}
    \caption{Idem Fig. \ref{fig3} for NGC 4349.}
    \label{fig63}
\end{figure*}
\begin{figure*}[ht]
    \centering
    \includegraphics[width=\hsize]{figs/low_res/dmap_ngc4349.png}
    \caption{Idem Fig. \ref{fig4} for NGC 4349.}
    \label{fig64}
\end{figure*}
\begin{figure*}[ht]
    \centering
    \includegraphics[width=\hsize]{figs/low_res/cmds_ngc4349.png}
    \caption{Idem Fig. \ref{fig5} for NGC 4349.}
    \label{fig65}
\end{figure*}
\begin{figure*}[ht]
    \centering
    \includegraphics[width=\hsize]{figs/low_res/plx_NGC4349.png}
...
\begin{figure*}[ht]
    \centering
    \includegraphics[width=\hsize]{figs/low_res/obs_RUP87.png}
    \caption{Idem Fig. \ref{fig3} for Ruprecht 87.}
    \label{fig23}
\end{figure*}
\begin{figure*}[ht]
    \centering
    \includegraphics[width=\hsize]{figs/low_res/dmap_rup87.png}
    \caption{Idem Fig. \ref{fig4} for Ruprecht 87.}
    \label{fig24}
\end{figure*}
\begin{figure*}[ht]
    \centering
    \includegraphics[width=\hsize]{figs/low_res/cmds_rup87.png}
    \caption{Idem Fig. \ref{fig5} for Ruprecht 87.}
    \label{fig25}
\end{figure*}
\begin{figure*}[ht]
    \centering
    \includegraphics[width=\hsize]{figs/low_res/plx_RUP87.png}
...
% but also to Trumpler 12 and van den Bergh-Hagen 92 achieving a good agreement
% too. van den Bergh-Hagen 73 and van den Bergh-Hagen 85 are well defined but
% faint and in the case of Ruprecht 162 we have shown in
...
% happens with van den Bergh-Hagen 92, while in the case of Trumpler 12 the
...
% objects van den Bergh-Hagen 106 and van den Bergh-Hagen 85 have no satisfying
% solution neither adding nor removing 0.1 mas since the situation gets worse.\\

\begin{figure*}[ht]
    \centering
    \includegraphics[width=\hsize]{figs/low_res/dist_comparision1.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\hsize]{figs/low_res/dist_comparision2.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\hsize]{figs/low_res/xy_xz.png}
...
\begin{figure*}[ht]
    \centering
    \includegraphics[width=\hsize]{figs/low_res/obs_RUP85.png}
...
\begin{figure*}[ht]
    \centering
    \includegraphics[width=\hsize]{figs/low_res/dmap_rup85.png}
...
\begin{figure*}[ht]
    \centering
    \includegraphics[width=\hsize]{figs/low_res/cmds_rup85.png}
...
\begin{figure*}[ht]
    \centering
    \includegraphics[width=\hsize]{figs/low_res/plx_RUP85.png}
...
\begin{figure*}[ht]
    \centering
    \includegraphics[width=\hsize]{figs/low_res/obs_vdBH85.png}
...
\begin{figure*}[ht]
    \centering
    \includegraphics[width=\hsize]{figs/low_res/dmap_vdbh85.png}
...
\begin{figure*}[ht]
    \centering
    \includegraphics[width=\hsize]{figs/low_res/cmds_vdbh85.png}
...
\begin{figure*}[ht]
    \centering
    \includegraphics[width=\hsize]{figs/low_res/plx_vdBH85.png}
...
\begin{figure*}[ht]
    \centering
    \includegraphics[width=\hsize]{figs/low_res/obs_vdBH87.png}
...
\begin{figure*}[ht]
    \centering
    \includegraphics[width=\hsize]{figs/low_res/dmap_vdbh87.png}
...
\begin{figure*}[ht]
    \centering
    \includegraphics[width=\hsize]{figs/low_res/cmds_vdbh87.png}
    \caption{Idem Fig. \ref{fig5} for van den Bergh-Hagen 87.}
    \label{fig17}
\end{figure*}
\begin{figure*}[ht]
    \centering
    \includegraphics[width=\hsize]{figs/low_res/plx_vdBH87.png}
...
\begin{figure*}[ht]
    \centering
    \includegraphics[width=\hsize]{figs/low_res/obs_TR12.png}
    \caption{Idem Fig. \ref{fig3} for Trumpler 12.}
    \label{fig19}
\end{figure*}
\begin{figure*}[ht]
    \centering
    \includegraphics[width=\hsize]{figs/low_res/dmap_trumpler12.png}
    \caption{Idem Fig. \ref{fig4} for Trumpler 12.}
    \label{fig20}
\end{figure*}
\begin{figure*}[ht]
    \centering
    \includegraphics[width=\hsize]{figs/low_res/cmds_tr12.png}
    \caption{Idem Fig. \ref{fig5} for Trumpler 12.}
    \label{fig21}
\end{figure*}
\begin{figure*}[ht]
    \centering
    \includegraphics[width=\hsize]{figs/low_res/plx_TR12.png}
...
\begin{figure*}[ht]
    \centering
    \includegraphics[width=\hsize]{figs/low_res/obs_vdBH91.png}
    \caption{Idem Fig. \ref{fig3} for van den Bergh-Hagen 91.}
    \label{fig27}
\end{figure*}
\begin{figure*}[ht]
    \centering
    \includegraphics[width=\hsize]{figs/low_res/dmap_vdbh91.png}
    \caption{Idem Fig. \ref{fig4} for van den Bergh-Hagen 91.}
    \label{fig28}
\end{figure*}
\begin{figure*}[ht]
    \centering
    \includegraphics[width=\hsize]{figs/low_res/cmds_vdbh91.png}
    \caption{Idem Fig. \ref{fig5} for van den Bergh-Hagen 91.}
    \label{fig29}
\end{figure*}
\begin{figure*}[ht]
    \centering
    \includegraphics[width=\hsize]{figs/low_res/plx_vdBH91.png}
...
\begin{figure*}[ht]
    \centering
    \includegraphics[width=\hsize]{figs/low_res/obs_RUP88.png}
    \caption{Idem Fig. \ref{fig3} for Ruprecht 88.}
    \label{fig31}
\end{figure*}
\begin{figure*}[ht]
    \centering
    \includegraphics[width=\hsize]{figs/low_res/dmap_rup88.png}
    \caption{Idem Fig. \ref{fig4} for Ruprecht 88.}
    \label{fig32}
\end{figure*}
\begin{figure*}[ht]
    \centering
    \includegraphics[width=\hsize]{figs/low_res/cmds_rup88.png}
    \caption{Idem Fig. \ref{fig5} for Ruprecht 88.}
    \label{fig33}
\end{figure*}
\begin{figure*}[ht]
    \centering
    \includegraphics[width=\hsize]{figs/low_res/plx_RUP88.png}
...
\begin{figure*}[ht]
    \centering
    \includegraphics[width=\hsize]{figs/low_res/obs_vdBH92.png}
    \caption{Idem Fig. \ref{fig3} for van den Bergh-Hagen 92.}
    \label{fig35}
\end{figure*}
\begin{figure*}[ht]
    \centering
    \includegraphics[width=\hsize]{figs/low_res/dmap_vdbh92.png}
    \caption{Idem Fig. \ref{fig4} for van den Bergh-Hagen 92.}
    \label{fig36}
\end{figure*}
\begin{figure*}[ht]
    \centering
    \includegraphics[width=\hsize]{figs/low_res/cmds_vdbh92.png}
    \caption{Idem Fig. \ref{fig5} for van den Bergh-Hagen 92.}
    \label{fig37}
\end{figure*}
\begin{figure*}[ht]
    \centering
    \includegraphics[width=\hsize]{figs/low_res/plx_vdBH92.png}
...
\begin{figure*}[ht]
    \centering
    \includegraphics[width=\hsize]{figs/low_res/obs_TR13.png}
    \caption{Idem Fig. \ref{fig3} for Trumpler 13.}
    \label{fig39}
\end{figure*}
\begin{figure*}[ht]
    \centering
    \includegraphics[width=\hsize]{figs/low_res/dmap_trumpler13.png}
    \caption{Idem Fig. \ref{fig4} for Trumpler 13.}
    \label{fig40}
\end{figure*}
\begin{figure*}[ht]
    \centering
    \includegraphics[width=\hsize]{figs/low_res/cmds_tr13.png}
    \caption{Idem Fig. \ref{fig5} for Trumpler 13.}
    \label{fig41}
\end{figure*}
\begin{figure*}[ht]
    \centering
    \includegraphics[width=\hsize]{figs/low_res/plx_TR13.png}
...
\begin{figure*}[ht]
    \centering
    \includegraphics[width=\hsize]{figs/low_res/obs_vdBH106.png}
    \caption{Idem Fig. \ref{fig3} for van den Bergh-Hagen 106.}
    \label{fig43}
\end{figure*}
\begin{figure*}[ht]
    \centering
    \includegraphics[width=\hsize]{figs/low_res/dmap_vdbh106.png}
    \caption{Idem Fig. \ref{fig4} for van den Bergh-Hagen 106.}
    \label{fig44}
\end{figure*}
\begin{figure*}[ht]
    \centering
    \includegraphics[width=\hsize]{figs/low_res/cmds_vdbh106.png}
    \caption{Idem Fig. \ref{fig5} for van den Bergh-Hagen 106.}
    \label{fig45}
\end{figure*}
\begin{figure*}[ht]
    \centering
    \includegraphics[width=\hsize]{figs/low_res/plx_vdBH106.png}
...
\begin{figure*}[ht]
    \centering
    \includegraphics[width=\hsize]{figs/low_res/obs_RUP162.png}
    \caption{Idem Fig. \ref{fig3} for Ruprecht 162.}
    \label{fig47}
\end{figure*}
\begin{figure*}[ht]
    \centering
    \includegraphics[width=\hsize]{figs/low_res/dmap_rup162.png}
    \caption{Idem Fig. \ref{fig4} for Ruprecht 162.}
    \label{fig48}
\end{figure*}
\begin{figure*}[ht]
    \centering
    \includegraphics[width=\hsize]{figs/low_res/cmds_rup162.png}
    \caption{Idem Fig. \ref{fig5} for Ruprecht 162.}
    \label{fig49}
\end{figure*}
\begin{figure*}[ht]
    \centering
    \includegraphics[width=\hsize]{figs/low_res/plx_RUP162.png}
...
\begin{figure*}[ht]
    \centering
    \includegraphics[width=\hsize]{figs/low_res/obs_LYNGA15.png}
    \caption{Idem Fig. \ref{fig3} for Lynga 15.}
    \label{fig51}
\end{figure*}
\begin{figure*}[ht]
    \centering
    \includegraphics[width=\hsize]{figs/low_res/dmap_lynga15.png}
    \caption{Idem Fig. \ref{fig4} for Lynga 15.}
    \label{fig52}
\end{figure*}
\begin{figure*}[ht]
    \centering
    \includegraphics[width=\hsize]{figs/low_res/cmds_lynga15.png}
    \caption{Idem Fig. \ref{fig5} for Lynga 15.}
    \label{fig53}
\end{figure*}
\begin{figure*}[ht]
    \centering
    \includegraphics[width=\hsize]{figs/low_res/plx_LYNGA15.png}
...
\begin{figure*}[ht]
    \centering
    \includegraphics[width=\hsize]{figs/low_res/obs_LODEN565.png}
    \caption{Idem Fig. \ref{fig3} for Loden 565.}
    \label{fig55}
\end{figure*}
\begin{figure*}[ht]
    \centering
    \includegraphics[width=\hsize]{figs/low_res/dmap_loden565.png}
    \caption{Idem Fig. \ref{fig4} for Loden 565.}
    \label{fig56}
\end{figure*}
\begin{figure*}[ht]
    \centering
    \includegraphics[width=\hsize]{figs/low_res/cmds_loden565.png}
    \caption{Idem Fig. \ref{fig5} for Loden 565.}
    \label{fig57}
\end{figure*}
\begin{figure*}[ht]
    \centering
    \includegraphics[width=\hsize]{figs/low_res/plx_LODEN565.png}
...
\begin{figure*}[ht]
    \centering
    \includegraphics[width=\hsize]{figs/low_res/obs_NGC4230.png}
    \caption{Idem Fig. \ref{fig3} for NGC 4230.}
    \label{fig59}
\end{figure*}
\begin{figure*}[ht]
    \centering
    \includegraphics[width=\hsize]{figs/low_res/dmap_ngc4230.png}
    \caption{Idem Fig. \ref{fig4} for NGC 4230.}
    \label{fig60}
\end{figure*}
\begin{figure*}[ht]
    \centering
    \includegraphics[width=\hsize]{figs/low_res/cmds_ngc4230.png}
    \caption{Idem Fig. \ref{fig5} for NGC 4230.}
    \label{fig61}
\end{figure*}
\begin{figure*}[ht]
    \centering
    \includegraphics[width=\hsize]{figs/low_res/plx_NGC4230.png}
